<template>
  <div id="app">
    ...
    <NewPlayer :birthdays="data.birthdays" :yesterdayCount="data.yesterdayCount" :playerCount="data.playerCount" :missingCount="data.missingCount" :newbies="data.newbies"></NewPlayer>
